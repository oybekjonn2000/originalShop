    ...
    <div class="brands-container fade-in-el">
      ...
      <div class="page-header">
        ...
        <div class="header-actions">
          <button (click)="deleteAllBrands()" class="btn-danger" style="display: inline-flex; align-items: center; gap: 5px; padding: 0.6rem 1rem; border: none; font-size: 0.9rem; font-weight: 600; border-radius: 8px; cursor: pointer; color: white;">

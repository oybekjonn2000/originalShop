        ...
        <table class="glass-table">
          ...
          <tbody>
            <tr *ngFor="let order of filteredOrders" [class.highlighted-row]="updatingOrderId === order.id">
              ...
              <td><strong class="amount">\${{ order.totalAmount | number:'1.2-2' }}</strong></td>
              <td>
          ...
          <div *ngIf="selectedOrder" class="modal-body">
            ...
            <div class="order-items-list">
              <div *ngFor="let item of selectedOrder.orderItems" class="order-item-row">
                ...
                <span class="order-item-price">\${{ item.price | number:'1.2-2' }}</span>
              </div>
            </div>

            <div class="order-total-row">
              <span>Jami to'lov:</span>
              <strong class="order-total-amount">\${{ selectedOrder.totalAmount | number:'1.2-2' }}</strong>
            </div>
          </div>
        </div>
      </div>
